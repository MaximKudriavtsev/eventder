...
curl -X POST https://hgdjzzd2ki.execute-api.eu-central-1.amazonaws.com/dev/todos --data '{ "text": "Learn Serverless" }'

curl https://hgdjzzd2ki.execute-api.us-east-1.amazonaws.com/dev/todos
